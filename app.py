...
st.set_page_config(page_title="Room Plan Evaluator (Updated Ideal)", layout="wide")
st.title("🏠 Room Plan Evaluator: Size & Adjacency Based")
...
if st.button("Evaluate Plan"):
    ...
    with col1:
        ...
        html_ideal = display_graph_pyvis(ideal_graph)
    ...
    with col2:
        ...
        html_candidate = display_graph_pyvis(candidate_graph)
